...
var levels = [
  ...
  },
  {
    ...
    controls:     '<div class="range-slider-container master"><label for="matrix-a" class="label">a</label><div class="track-container"><input class="range-slider" type="range" id="matrix-a" name="matrix-a" min="-1" max="1" value="0" step="0.1"><div class="value-label"></div><div class="min-value"></div><div class="max-value"></div></div></div><div class="range-slider-container active"><label for="matrix-b" class="label">b</label><div class="track-container"><input class="range-slider" type="range" id="matrix-b" name="matrix-b" min="-100" max="100" value="20" step="1"><div class="value-label"></div><div class="min-value"></div><div class="max-value"></div></div></div><div class="range-slider-container disabled"><label for="matrix-c" class="label">c</label><div class="track-container"><input class="range-slider" type="range" id="matrix-c" name="matrix-c" min="-300" max="300" value="0" step="1" disabled><div class="value-label"></div><div class="min-value"></div><div class="max-value"></div></div></div>'
  },
  {
    title:        '<h2>Scale</h2>',
